...
class UploadImage extends Component {
    constructor(props) {
    super(props);
    this.state = {selectedFiles:[],image:[],file:null,event:null};
  ...
  uploadHandler(event) {
      ...
      if(file){
            ...
            axios.post('localhost:9090/UploadFile', reader.result).then(res =>{
            console.log(res);
             });
*/
      }
      
    //  this.props.value.push(this.state.selectedFile);
  }
  getCarousel(){
